...
4. Never invent citations, authors, or quotes not in excerpts.
5. Respond in JSON: { "answer": string, "sourceGrounded": boolean, "citations": [{ "sourceTitle": string, "excerpt": string, "sourceIndex": number|null, "confidence": "high"|"medium"|"low"|"uncertain" }], "suggestedClaims": [{ "text": string, "citationIndexes": number[] }], "generalNote": string|null }`
